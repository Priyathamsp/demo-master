              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Row(
                      children: [
                        Positioned(
                          ...
                          bottom: 0,
                          child: Padding(
                            padding: EdgeInsets.only(left: 8.0.w, top: 3.0.w,bottom: 3.0.w), // Adjust the padding as needed
                            child: Image.asset(
                     ...
                     Padding(padding: EdgeInsets.only(left: 5.0.w, right: 5.0.w,top: 3.0.w, bottom: 1.0.w),
                      child: Row(
                        children: [
                          Text("Pick Up",
                    ...
                    Padding(padding: EdgeInsets.only(left: 5.0.w, right: 5.0.w, top: 3.0.w, bottom: 3.0.w),
                      child: Row(
                        children: [
                           Text("Pass Count",
                            style: TextStyle(color: Colors.black,fontSize: 14.sp, fontWeight: FontWeight.bold),),
                    ...
                    Padding(padding: EdgeInsets.only(left: 5.0.w, right: 5.0.w, top: 3.0.w, bottom: 0.0.w),
                      child: Row(
                        children: [
                    ...
                    Padding(padding: EdgeInsets.only(left: 5.0.w, right: 5.0.w, top: 0.0.w),
                      child: Row(
                        children: [
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        // Daily Ticket text
                       Padding(
                          padding: EdgeInsets.only(left: 40.0.w), // Adjust the padding as needed
                          child: Text(
                            "Weekly Pass",
                            style: TextStyle(color: Colors.black, fontSize: 20.sp, fontWeight: FontWeight.bold),
                          ),
