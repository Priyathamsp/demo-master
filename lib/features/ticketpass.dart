              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(padding: EdgeInsets.only(left: 5.0.w, right: 5.0.w, top: 3.0.w, bottom: 5.0.w),
                      child: Row(
                        children: [
                           Text("Pass Count",
                            style: TextStyle(color: Colors.black,fontSize: 14.sp, fontWeight: FontWeight.bold),),
                    ...
                    Padding(padding: EdgeInsets.only(left: 5.0.w, right: 5.0.w, top: 6.0.w, bottom: 3.0.w),
                      child: Row(
                        children: [
                    ...
                    Padding(padding: EdgeInsets.only(left: 5.0.w, right: 5.0.w, top: 3.0.w),
                      child: Row(
                        children: [
